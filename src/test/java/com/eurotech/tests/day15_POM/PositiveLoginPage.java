...
public class PositiveLoginPage extends TestBase {
    ...
    public void loginTest() throws InterruptedException {
        ...
        Thread.sleep(2000);
        Assert.assertEquals(driver.getCurrentUrl(), "http://www.eurotech.study/dashboard");
    ...
    public void loginWithMethod() {
        driver.get(ConfigurationReader.get("url"));
        loginPage.login(ConfigurationReader.get("usernameTeacher"), ConfigurationReader.get("passwordTeacher"));

        //System.out.println(loginPage.dashboardText.getText());
        wait.until(ExpectedConditions.visibilityOf(loginPage.dashboardText));
